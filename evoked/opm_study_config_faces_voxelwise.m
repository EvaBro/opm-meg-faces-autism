function p = opm_study_config_faces_voxelwise()
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% p = opm_study_config()
%
...
p.pipeline_name = 'faces_ASDvTDC_voxelwise_2025-03-19';%
...
% p.sourcemodel.coordinates.ve_atlas = 'AAL90';
...
% GET TS FOR ALL VOXELS IN PARCEL
p.sourcemodel.grid.ts.all = 1;
p.sourcemodel.grid.ts.all_rois = 0;
...
p.sourcemodel.grid.ts.foi = [4, 40]; 

% Parcellation to use
p.sourcemodel.grid.ts.atlas_name = 'fusiformmask';
